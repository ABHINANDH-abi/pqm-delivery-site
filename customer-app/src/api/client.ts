...
// Smart Connection Intelligence: Determine optimal base URL based on environment & device platform
...
export const apiClient = axios.create({
  ...
  timeout: 15000, // 15 seconds to gracefully handle Render cloud backend cold starts
});
